...
class BaseRequestTest extends TestCase
{
    ...
    public function testGetOrderableFields()
    {
        ...
        $expectedResult = 'id,name,json_field,castable_field,cast_binary_field,binary_field,*,created_at,updated_at';
    ...
    public function testGetOrderableFieldsWithAdditionalFields()
    {
        ...
        $expectedResult = 'id,name,json_field,castable_field,cast_binary_field,binary_field,*,created_at,updated_at,additional_field_1,additional_field_2';
